...
use Omni\Encryption\Key\FallbackKeysSource;

class FallbackKeysSourceTest extends AbstractSourceTest
{
    public function gettersHassersProvider()
    {
        ...
        return array(
            array(
                new FallbackKeysSource($fallbacks, new ArraySource($keys)),
                $existingKeys,
